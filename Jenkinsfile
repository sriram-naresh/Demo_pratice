    ...
    stage('Push to ECR') {
      steps {
        script {
          ...
          sh 'docker tag hello-world-app 320565985336.dkr.ecr.us-east-1.amazonaws.com:latest'
          sh 'docker push docker push 320565985336.dkr.ecr.us-east-1.amazonaws.com/hello-world-app:latest'
        }
      }
    }
  }
